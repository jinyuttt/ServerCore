...
public class FileUtil {
    ...
    public static String encodeInMD5(final String inputStr) {
        ...
        return DigestUtils.md5Hex(inputStr.getBytes());
    }
     ...
     * @return
     */
    private static boolean deleteAllFileInFolder(String path) {
        boolean flag = false;
     ...
     */
    private static boolean moveFile(final String srcFileName, final String destDirName, String originalFileName) {
...
//                        }
    ...
    public static String unrar(String rarFilePath, String targetPath, boolean isInSameDir) {
        ...
        try {
            ...
            String cmd = "unrar X -o+ " + rarFilePath + " " + targetPath;
            //解压
     ...
     * @return
     */
    private static List<Map<String, String>> getFiles(String path, List<Map<String, String>> mapList) {
        File file = new File(path);
                ...
                for (int i = 0; i < sourceFiles.length; i++) {
                    ...
                    if (file.isDirectory()) {
                        ...
                        if (file.getName().contains(fileName)) {
                            logger.info("存在重复的文件名：" + file.getName());
                            continue;
                        }
                        //创建ZIP实体，并添加进压缩包
